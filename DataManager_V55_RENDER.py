...
# Render persistent disk - PRIORIDADE: /data
...
# =============================================================================
# GERAÇÃO DE TIMEFRAMES (COPIADO DO V51)
# =============================================================================
def gerar_timeframe_tratado(csv_agg_path, csv_tf_path, timeframe_min=15, min_val_usd=500, chunksize=200_000):
    ...
    # ENRIQUECIMENTO V1 (COPIADO DO V51)
...
def feature_engine(df):
    ...
    # 6. ATR14 (NECESSÁRIO PARA REGIMES)
    tr = pd.concat([
        (df["high"] - df["low"]),
...
def adicionar_features_avancadas(df):
    """Features avançadas - COPIADO DO V27."""
    df = df.copy()
...
# =============================================================================
# DETECÇÃO DE REGIMES (COPIADO EXATO DO V27)
# =============================================================================
...
def preparar_futuros(df: pd.DataFrame, N: int) -> pd.DataFrame:
    ...
    # Remover últimas N linhas (sem futuro)
    df = df.iloc[:-N].reset_index(drop=True)

    return df

# =============================================================================
# MONTAR MATRIZ (COPIADO EXATO DO V27)
# =============================================================================
...
# =============================================================================
# SPLIT TEMPORAL (COPIADO EXATO DO V27)
# =============================================================================
def temporal_split(X, y, gap=15):
    """Split temporal 70/10/20 com gap. COPIADO EXATO DO V27."""
    n = len(X)
    tr = int(n * 0.70)
    va = int(n * 0.80)
...
# =============================================================================
# TREINAR UM TARGET (COPIADO EXATO DO V27)
# =============================================================================
