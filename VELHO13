# DATA MANAGER INSTITUCIONAL ELITE V16 - V8 SECURE EDITION
# 1. Corrige Diluição (Sliding Window)
# 2. Captura Total (ID Discovery + Time Fallback)
# 3. Log a cada 10.000 trades
# 4. Envio Seguro para Telegram (Via Environment Variables)
...
# --- CONFIGURAÇÕES SEGURAS (Lidas do Render) ---
...
def send_to_telegram(file_path):
    if not TELEGRAM_TOKEN or not TELEGRAM_CHAT_ID:
        print("[ERRO] Variáveis TG_TOKEN ou TG_CHAT não configuradas no Render!")
        return
