...
SYMBOL = "PENDLEUSDT"
START_DT_STR = "2025-11-15"  # Data início (YYYY-MM-DD) - 2 MESES
...
# ============================================================================
# 🔧 BLOCO DE BACKTEST TARGET_K REMOVIDO PARA RENDER
# ============================================================================
# Modelos K1-K6 JÁ foram treinados no bloco anterior (MÓDULO 6)
# Este bloco de análise de acurácia foi removido para economizar tempo
# Os PKLs serão exportados normalmente pelo Exportador V22
# ============================================================================
print('>>> Backtest TARGET_K removido - economizando tempo no Render')
print('>>> Modelos K já foram treinados e serão exportados')
